  ...
  return (
    <div className="fade-in">
      <section className="relative min-h-screen overflow-hidden bg-ink text-white">
        <img src="/images/nxrth-black-models-hero.png" alt="Black models wearing premium NXRTH STUDIO clothing" className="absolute inset-0 h-full w-full object-cover opacity-70" />
        ...
        <div className="container-pad relative flex min-h-screen items-end pb-24 pt-32">
          ...
          <div className="absolute bottom-8 right-8 hidden text-xs uppercase tracking-[0.22em] text-white/70 md:block">Scroll</div>
        </div>
      </section>
      ...
      <section className="container-pad py-16 sm:py-24">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <CategoryCard title="New Arrivals" image="/images/nxrth-mountain-tee.png" filter="T-Shirts" />
          <CategoryCard title="Limited Drops" image="/images/nxrth-branded-collection.png" filter="Jackets" />
        </div>
      </section>
        ...
        <div className="container-pad">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <img src="/images/nxrth-branded-collection.png" alt="NXRTH branded clothing collection editorial flat lay" className="aspect-[4/5] w-full object-cover sm:mt-12" />
            </div>
          </div>
